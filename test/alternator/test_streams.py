...
def test_streams_putitem_new_item_overrides_old_lsi(test_table_sss_new_and_old_images_lsi, dynamodbstreams):
    def do_updates(table, p, c):
        events = []
...
def test_streams_putitem_no_ck_new_item_overrides_old(test_table_s_no_ck_new_and_old_images, dynamodbstreams):
    def do_updates(table, p, _):
        events = []
